...
purpose_counts.plot(kind='bar', color='blue')
plt.xlabel('Purpose')
plt.ylabel('Count')
...
round_trip_counts.plot(kind='bar', color='blue')
...
sns.countplot(x='month', data=df, order=df['month'].value_counts().index, palette='deep')
plt.xlabel('Month')
plt.ylabel('Count')
...
round_trip_counts.plot(kind='bar', stacked=True)
plt.xlabel('Round Trip')
plt.ylabel('Count')
...
st.subheader('Bar Plots of Start and Stop Locations')
